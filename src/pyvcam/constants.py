...
PP_FEATURE_DESPECKLE_BRIGHT_HIGH_ENABLED = (
    PP_FEATURE_DESPECKLE_BRIGHT_HIGH * PP_MAX_PARAMETERS_PER_FEATURE
)
PP_FEATURE_DESPECKLE_BRIGHT_HIGH_THRESHOLD = (
    PP_FEATURE_DESPECKLE_BRIGHT_HIGH_ENABLED + 1
)
PP_FEATURE_DESPECKLE_BRIGHT_HIGH_MIN_ADU_AFFECTED = (
    PP_FEATURE_DESPECKLE_BRIGHT_HIGH_THRESHOLD + 1
)
PP_FEATURE_DESPECKLE_DARK_LOW_ENABLED = (
    PP_FEATURE_DESPECKLE_DARK_LOW * PP_MAX_PARAMETERS_PER_FEATURE
)
...
PP_FEATURE_DESPECKLE_DARK_LOW_MAX_ADU_AFFECTED = (
    PP_FEATURE_DESPECKLE_DARK_LOW_THRESHOLD + 1
)
PP_FEATURE_DEFECTIVE_PIXEL_CORRECTION_ENABLED = (
    PP_FEATURE_DEFECTIVE_PIXEL_CORRECTION * PP_MAX_PARAMETERS_PER_FEATURE
)
PP_FEATURE_DYNAMIC_DARK_FRAME_CORRECTION_ENABLED = (
    PP_FEATURE_DYNAMIC_DARK_FRAME_CORRECTION * PP_MAX_PARAMETERS_PER_FEATURE
)
PP_FEATURE_HIGH_DYNAMIC_RANGE_ENABLED = (
    PP_FEATURE_HIGH_DYNAMIC_RANGE * PP_MAX_PARAMETERS_PER_FEATURE
)
PP_FEATURE_DESPECKLE_BRIGHT_LOW_ENABLED = (
    PP_FEATURE_DESPECKLE_BRIGHT_LOW * PP_MAX_PARAMETERS_PER_FEATURE
)
...
PP_FEATURE_DESPECKLE_BRIGHT_LOW_MAX_ADU_AFFECTED = (
    PP_FEATURE_DESPECKLE_BRIGHT_LOW_THRESHOLD + 1
)
...
PP_FEATURE_DESPECKLE_DARK_HIGH_ENABLED = (
    PP_FEATURE_DESPECKLE_DARK_HIGH * PP_MAX_PARAMETERS_PER_FEATURE
)
...
PP_FEATURE_DESPECKLE_DARK_HIGH_MIN_ADU_AFFECTED = (
    PP_FEATURE_DESPECKLE_DARK_HIGH_THRESHOLD + 1
)
PP_FEATURE_ENHANCED_DYNAMIC_RANGE_ENABLED = (
    PP_FEATURE_ENHANCED_DYNAMIC_RANGE * PP_MAX_PARAMETERS_PER_FEATURE
)
PP_FEATURE_FRAME_SUMMING_ENABLED = (
    PP_FEATURE_FRAME_SUMMING * PP_MAX_PARAMETERS_PER_FEATURE
)
